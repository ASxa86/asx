...
TEST(Bytes, char_ToBytes)
{
	...
	const auto value = asx::ToBytes(test);
...
TEST(Bytes, char_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<char>(value), test);
}
...
TEST(Bytes, short_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<short>(value), test);
}
...
TEST(Bytes, int_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<int>(value), test);
}
...
TEST(Bytes, long_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<long>(value), test);
}
...
TEST(Bytes, longlong_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<long long>(value), test);
}
...
TEST(Bytes, float_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<float>(value), test);
}
...
TEST(Bytes, double_BytesTo)
{
	...
	EXPECT_EQ(asx::BytesTo<double>(value), test);
}
...
TEST(Bytes, string)
{
	...
	const auto v = asx::BytesTo<std::string>(value);
	EXPECT_EQ(v, test);
}
...
TEST(Bytes, array_string)
{
	...
	const auto v = asx::BytesTo<std::array<std::string, 4>>(value);
	EXPECT_EQ(v, test);
}
...
TEST(Bytes, pair)
{
	...
	const auto v = asx::BytesTo<decltype(test)>(value);
	EXPECT_EQ(v, test);
}
