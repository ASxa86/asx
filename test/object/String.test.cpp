...
TEST(String, bool)
{
	...
	const auto value = asx::StringTo<bool>(string);
...
TEST(String, float)
{
	...
	EXPECT_FLOAT_EQ(f, asx::StringTo<float>(string));
}
...
TEST(String, double)
{
	...
	const auto string = asx::ToString(f);
	EXPECT_FLOAT_EQ(f, asx::StringTo<double>(string));
}
...
{
	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::StringTo<decltype(test)>(string);
		EXPECT_EQ(value, test);
	}
...
TEST(String, pair_int)
{
	...
	const auto string = asx::ToString(test);
	const auto value = asx::StringTo<std::pair<int, int>>(string);
	EXPECT_EQ(value, test);
}
...
TEST(String, pair_string)
{
...

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::StringTo<std::pair<std::string, std::string>>(string);
		EXPECT_EQ(value, test);
	}
...
TEST(String, pair_int_string)
{
...

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::StringTo<std::pair<std::string, int>>(string);
		EXPECT_EQ(value, test);
	}

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::StringTo<std::pair<int, std::string>>(string);
		EXPECT_EQ(value, test);
	}
}
