...
TEST(String, float)
{
	...
	const auto string = asx::ToString(f);
	EXPECT_FLOAT_EQ(f, asx::FromString<float>(string));
}
...
TEST(String, double)
{
	...
	const auto string = asx::ToString(f);
	EXPECT_FLOAT_EQ(f, asx::FromString<double>(string));
}
...
{
	{
		...
		constexpr auto test{Test::One};
		const auto string = asx::ToString(test);
		const auto value = asx::FromString<Test>(string);
		EXPECT_EQ(value, test);
	}
...
{
	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::FromString<decltype(test)>(string);
		EXPECT_EQ(value, test);
	}
...
TEST(String, pair_int)
{
	...
	const auto string = asx::ToString(test);
	const auto value = asx::FromString<std::pair<int, int>>(string);
	EXPECT_EQ(value, test);
}
...
TEST(String, pair_string)
{
...

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::FromString<std::pair<std::string, std::string>>(string);
		EXPECT_EQ(value, test);
	}
...
TEST(String, pair_int_string)
{
...

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::FromString<std::pair<std::string, int>>(string);
		EXPECT_EQ(value, test);
	}

	{
		...
		const auto string = asx::ToString(test);
		const auto value = asx::FromString<std::pair<int, std::string>>(string);
		EXPECT_EQ(value, test);
	}
}
